...
CONFIG = {
    'CACHE_TTL': int(os.environ.get('CACHE_TTL', 90)),  # Cache for 90 seconds
    ...
    'UPDATE_INTERVAL': int(os.environ.get('UPDATE_INTERVAL', 120)),  # Background update interval in seconds
